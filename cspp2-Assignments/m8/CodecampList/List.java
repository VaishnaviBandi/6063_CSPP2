...
public class List {
    ...
    */
     ...
     */
    /**.
     * { function_description: function to add the items to the array}
     *
     * @param      item  The item
     */
     ...
     */
    /**.
     * { function_description :funtion to return the size of the array}
     *
     ...
     */
    /**.
     * { function_description: The function to remove elements from the array}
     *
     ...
     */
    /**.
     * { function_description: the funtion to get the index }
     *
     * @param      index  The index
     */
