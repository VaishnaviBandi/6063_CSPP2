...
public final class Client {
	...
	public static String fileRead(String folder, String name) throws Exception {
		BufferedReader br = new BufferedReader(new FileReader("H:\\CSPP2\\6063_CSPP2\\cspp2-Assignments\\m24\\Bagofwords\\"+folder+"\\"+name));
		String content = "";
		String line;
		try {
	...
	public static void main(String[] args) throws Exception{
		...
		File file = new File("H:\\CSPP2\\6063_CSPP2\\cspp2-Assignments\\m24\\Bagofwords\\f"+folder);
